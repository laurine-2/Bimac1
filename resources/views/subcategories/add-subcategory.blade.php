...
@section('page-content')
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Create Subcategory</h4>
            ...
            <form id="creatproduct-form" method="post" action="{{route('add-subcategory')}}" autocomplete="off" enctype="multipart/form-data">
                @csrf
                <div class="row">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <input name="title" required type="text" class="form-control" id="product-title-input" value="" placeholder="Enter title" required>
