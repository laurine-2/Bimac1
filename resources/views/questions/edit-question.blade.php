...
@section('page-content')
    <div class="page-content">
        <div class="container-fluid">
            ...
            <form id="creatproduct-form" method="post" action="{{route('edit-question')}}" autocomplete="off" enctype="multipart/form-data">
                @csrf
                <div class="row">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select required name="subcategory_id" class="form-select" id="choices-publish-status-input" data-choices data-choices-search-false>
                                        @foreach ($subcategories as $subcategory)
                                            <option @if ($question->subcategory_id == $subcategory->id) selected @endif  value="{{$subcategory->id}}">{{$subcategory->title}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <input name="reponse_1" value="{{$question->reponse_1}}" type="text" class="form-control" id="product-title-input" value="" placeholder="Enter response" required>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input name="reponse_2" value="{{$question->reponse_2}}" type="text" class="form-control" id="product-title-input" value="" placeholder="Enter response" required>
                                    <div class="invalid-feedback">Please Enter a question title.</div>
                                </div>
                                <div class="mb-3">
                                    <label class="form-label" for="product-title-input">Réponse 3</label>
                                    <input name="reponse_3" value="{{$question->reponse_3}}" type="text" class="form-control" id="product-title-input" value="" placeholder="Enter response" required>
                                    <div class="invalid-feedback">Please Enter a question title.</div>
                                </div>
                                <div class="mb-3">
                                    <label class="form-label" for="product-title-input">Réponse 4</label>
                                    <input name="reponse_4" value="{{$question->reponse_4}}" type="text" class="form-control" id="product-title-input" value="" placeholder="Enter response" required>
                                    <div class="invalid-feedback">Please Enter a question title.</div>
                                </div>
                            </div>
                            <!-- end card body -->
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="card d-none">
                                    <input rows="10" required value="{{$question->description}}"  class="form-control" id="description" name="description">
